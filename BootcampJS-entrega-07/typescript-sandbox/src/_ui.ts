...
export const createCard = (cardUrl: string): HTMLImageElement => {
  ...
  if (
    playedCard instanceof HTMLImageElement &&
    playedCard !== null &&
...
export const drawCard = (playedCard: HTMLImageElement): void => {
  ...
  if (
    gameBoard instanceof HTMLDivElement &&
    gameBoard !== null &&
    gameBoard !== undefined
  ) {
...
export const oneMoreTimeButton = (): void => {
  ...
  if (
    oneMore instanceof HTMLButtonElement &&
    oneMore !== null &&
    oneMore !== undefined
  ) {
...
export const setGiveUpStatus = (gameStatus: string): void => {
  ...
  if (
    giveUpPanel instanceof HTMLDivElement &&
    giveUpPanel !== null &&
    giveUpPanel !== undefined
  ) {
